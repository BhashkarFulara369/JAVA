...
<head>
    <meta charset="UTF-8">
        ...
        /* Page Background */
        body {
            background-image: url("airplanes.jpeg");
        ...
        /* Flight class selection grid */
        .seat-map {
            display: grid;
            grid-template-columns: repeat(2, 150px); /* Two columns for better layout */
            gap: 15px;
            justify-content: center;
            margin-top: 15px;
        }
        ...
        /* Available classes (Green) */
        .seat.available {
            background-color: #28a745;
            color: white;
        }

        /* Unavailable classes (Gray) */
        .seat.booked {
            background-color: gray;
            color: white;
            cursor: not-allowed;
...
<div class="container mt-5">
    <div class="text-center">
        <h2 class="fw-bold"><i class="fas fa-plane"></i> Flight Ticket Booking</h2>
                    <p>Book your flight tickets easily with our seamless booking system.</p>
                </div>

                <form action="/E-Ticketing_System/FlightBookingServlet" method="post">
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <div class="booking-card">
                                <h3 class="section-title"><i class="fas fa-map-marker-alt"></i> Flight Details</h3>
                                <div class="mb-3">
                                    <label for="source" class="form-label">From (Departure)</label>
                                    <input type="text" class="form-control" id="source" name="source" required>
                                </div>
                                <div class="mb-3">
                                    <label for="destination" class="form-label">To (Arrival)</label>
            ...
            <div class="col-md-4">
                <div class="booking-card">
                    <h3 class="section-title"><i class="fas fa-chair"></i> Class Selection</h3>

                    <div class="d-flex align-items-center mb-3">
                        <button id="showSeatsBtn" class="btn btn-primary"> Show Available Classes</button>
...
<script>
    ...
    showSeatsBtn.addEventListener("click", function () {
        ...
        flightClasses.forEach(flightClass => {
            const isBooked = Math.random() < 0.3; // Randomly mark some classes as unavailable
            const seat = document.createElement("button");

            seat.classList.add("seat", isBooked ? "booked" : "available");
            seat.innerText = flightClass;
            ...
            if (!isBooked) {
                seat.addEventListener("click", function () {
                    ...
                    selectedSeatDisplay.innerText = "Flight Class: " + this.innerText;
